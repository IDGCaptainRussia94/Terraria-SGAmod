...
namespace SGAmod.Tiles
{
    public class LuminousAlter : ModTile,IHopperInterface
    {
        ...
        public override void SetDefaults()
        {
            ...
            TileObjectData.newTile.HookPostPlaceMyPlayer = new PlacementHook(GetInstance<LuminousAlterTE>().Hook_AfterPlacement, -1, 0, true);
        ...
        public override void SpecialDraw(int i, int j, SpriteBatch spriteBatch)
        {
            ...
            if (Main.tile[i, j].type == base.Type)
            {
                if (tile.frameX == 0 && tile.frameY == 0)
                {
                    ...
                    Texture2D star = ModContent.GetTexture("SGAmod/Tiles/LuminousAlterStar");
