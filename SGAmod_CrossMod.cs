	...
	public partial class SGAmod : Mod
	{
		...
		public override void PostSetupContent()
		{
			...
			if (bossList != null)
			{
				...
				bossList.Call("AddMiniBoss", 9.5f, ModContent.NPCType<SharkvernHead>(), this, "Tempest Sharkvern", (Func<bool>)(() => SGAWorld.tidalCharmUnlocked), new List<int>() { ModContent.ItemType<ConchHorn>() }, new List<int>() { }, new List<int>() { ModContent.ItemType<SerratedTooth>(), ModContent.ItemType<SharkTooth>(), ModContent.ItemType<Jaws>(), ModContent.ItemType<SnappyShark>(), ModContent.ItemType<SkytoothStorm>(), ModContent.ItemType<SharkBait>(), ItemID.Starfish, ItemID.Seashell, ItemID.Coral, ItemID.SharkFin, ItemID.SoulofFlight }, "Use a [i:" + ItemType("ConchHorn") + "] at the ocean while it is raining", "The Sharkvern retreats back into seclusion", "SGAmod/NPCs/Sharkvern/SharkvernWhole");
				...
				bossList.Call("AddMiniBoss", 14.9f, ModContent.NPCType<PrismBanshee>(), this, "Aurora Banshee", (Func<bool>)(() => SGAWorld.downedPrismBanshee > 1), new List<int>() { ModContent.ItemType<PrismaticBansheeStar>() }, new List<int>() { }, new List<int>() { ModContent.ItemType<AuroraTear>() }, "Use a [i:" + ModContent.ItemType<PrismaticBansheeStar>() + "] in the underground Hallow, this version drops double the resources, but it is quite stronger", "Banshee has left");
